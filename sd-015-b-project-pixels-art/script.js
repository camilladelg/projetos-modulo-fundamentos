...
function defineInput() {
  ...
  const getelementPixelBoard = document.getElementById('pixel-board');
...
function buttonGenerate() {
  const getGenerateButton = document.getElementById('generate-board');
